      ...
      <div className="relative w-full  flex flex-col items-center justify-between bg-[var(--color-primary-lighter)] dark:bg-[var(--color-secondary-darker)]  p-10 max-lg:hidden">
        <div className=" self-start">
          <div className=" relative">
            ...
            <p className=" absolute top-0  right-12 text-[8px] rounded-xl text-[var(--color-secondary)] font-normal border border-[var(--color-secondary)] px-[5px] py-[1px]">Consult</p>
          </div>
          <p className=" text-gray-400 text-sm font-light mt-1">Consult Insights, Made Easy</p>
        </div>
        ...
        <div className=" self-start  w-full px-5 py-5">
          <div className="  lg:hidden">
            <div className=" relative">
              ...
              <p className=" absolute top-0  left-[90px] text-[8px] rounded-xl text-[var(--color-primary-lighter)] font-normal border border-[var(--color-primary-lighter)] px-[5px] py-[1px]">Consult</p>
            </div>
            <p className=" text-[var(--color-primary-light)] text-sm font-light mt-1">Consult Insights, Made Easy</p>
          </div>
